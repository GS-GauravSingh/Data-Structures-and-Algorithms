...
public:
    /* Question: We are given an array ‘ARR’ with N positive integers. We need to find if we can partition the array into two subsets such that the sum of elements of each subset is equal to the other. If we can partition, return true else return false. */
    bool canPartition(vector<int> &arr, int n)
    {
        // Now, we have to divide this array into 2 subsets such that,
        // Sum of elements of S1 = Sum of elements of S2 and,
        // S1 + S2 = Sum of all elements of arr (let's called this as 'S'). S1+S2 = S.

        // These two conditions imply that S1 = S2 = (S/2).

        // Traverse the array and calculate the sum of all the element of 'arr' and store the sum of all elements somewhere.
        int sum = 0;
        for (auto i : arr)
        {
            sum += i;
        ...
        else
        {
            ...
            // // Recursive Solution.
            // return solveRecursive(n - 1, target, arr);

            // // DP Memoization Solution.
            // vector<vector<int>> dp(n, vector<int>(target + 1, -1));
            // return solveMemoized(n-1, target, arr, dp);

            // // DP Tabulation Solution.
            // return solveTabulized(arr, target);

            // Space Optimized Solution.
            return solveSpaceOptimized(arr, target);
        }
    }
};
...
int main(void)
{
    ...
    // Solution.
    Solution S;
    cout << "Can Partition or Not : " << ((S.canPartition(arr, n)) ? "Yes." : "No.");
