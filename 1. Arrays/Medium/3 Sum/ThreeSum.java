...
public class ThreeSum {
    ...
    // Time Complexity :- O(n log(n)) + O(n^2), n log(n) for sorting, 
    // and O(n^2) for iterating through the array.
    ...
    static List<List<Integer>> threeSum(int[] nums) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            while (start < end) {
                ...
                if (sum == target) {
                    ans.add(Arrays.asList(firstNumber, secondNumber, thirdNumber));
